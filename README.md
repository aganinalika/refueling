...
***
 ...
 Определение главных действующих лиц и их основных функций в информационной системе реализовано на диаграмме Use Case.
 
![alt text](Screen/UCD.png)

 На диаграмме потоков данных (Data-flow diagram), изображено как процессы и хранилища связаны потоками данных. 

![alt text](Screen/DFD.png)

 На диаграмме Сущность-Связь (Entity-Relationship diagram) отображаются сущности (хранилища) и связи между ними. 
