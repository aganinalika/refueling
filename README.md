...
***
 ...
 Определение главных действующих лиц информационной системы и покажем их основные функции на диаграмме Use Case.
 
![alt text](Screen/UCD.png)

 Используя диаграмму потоков данных (Data-flow diagram), покажем как процессы и хранилища связаны потоками данных. 

![alt text](Screen/DFD.png)

 На диаграмме Сущность-Связь (Entity-Relationship diagram) 
